@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between flex-col my-8">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between flex-col gap-3">
            <div>
